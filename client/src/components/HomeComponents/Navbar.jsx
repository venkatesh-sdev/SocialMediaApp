...
const Navbar = ({ user }) => {
  ...
  return (
    <nav className="flex px-5 py-1 items-center justify-between sticky z-10 inset-0 w-full bg-white">
      ...
      <div className="w-96 flex items-center gap-5 justify-end">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={() => {}}
            className="w-9 h-9 hidden sm:flex justify-center items-center bg-gray-100 rounded-lg hover:bg-gray-200 transition-all duration-500"
          >
            ...
            {popUpBar && (
              ...
              >
                ...
                <button
                  ...
                  className="flex items-center justify-between gap-2 px-6 py-2 border-b border-gray-200 hover:bg-gray-200 transition-all duration-500 w-full rounded-md"
                >
                  Logout
                  <IoIosLogOut size={20} />
                </button>
                ...
                <button
                  onClick={handleLogout}
                  className="flex lg:hidden items-center justify-between  gap-2 px-6 py-2 border-b border-gray-200 hover:bg-gray-200 transition-all duration-500 w-full rounded-md"
                >
                  Message
